...
public class LoanQualifier {
	...
	public static void main(String[] args) {
		...
		if(salary>=salaryRequired) 
		{
			...
			{
			System.out.println("Sorry, you must have atleast " + experienceRequired +" years experience. You are not qualified for the loan");
			}
		}
		else 
		{
			System.out.println("Sorry, you must have atleast $" + salaryRequired + " salary. You are not qualified for the loan");	
		}
	}
}
